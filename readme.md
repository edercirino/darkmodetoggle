...
- [x] toogle clean mode to dark mode

### 🧐 Demonstration

<h1 align=center>
<img alt="Weight Converter" title="main page" src="./screenshots/screenshot1.png">
<img alt="Weight Converter" title="main page" src="./screenshots/screenshot2.png">
</h1>
...
- Change from clean mode to dark mode
